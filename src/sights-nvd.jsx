...
class SightsNVD extends React.Component{
    ...
    constructor(props) {
        ...
        this.state = {first: "", second: "", second_third: "second-third", second_block: "second-block", third_block: "third-block", second_pic: "second-pic", first_pic: "first-pic", update: "updated", crs: "auf", cmp: ""}
    ...
    {
        e.preventDefault()
        if (this.state.menu === "lighter-button")
        {
            this.state.menu = "lighter-button-pressed"
        }
        else this.state.menu = "lighter-button"
    ...
    <div className="flex-wrapper">
                    ...
                    <div className="page-blocks">
                        ...
                        <div className={this.state.second_block} id="second-block">
                                <button className={this.state.crs} id="CRS_BUT" onClick={e=>{this.handleOpen(e, "crs");}}> COMPACT REFLEX SIGHTS</button>
                            ...
                            <button className={this.state.lighter_button} id="RS_BUT" onClick={e=>{this.handleOpen(e, "RS");}}>REFLEX SIGHTS</button>
                            <div id="RS" className="menu-pop">
                                ...
                                <button className={this.state.lighter_button} id="AS_BUT" onClick={e=>{this.handleOpen(e, "AS");}}> ASSAULT SCOPES</button>
                            <div id="AS" className="menu-pop">
                                ...
                                <button className={this.state.lighter_button} id="SC_BUT" onClick={e=>{this.handleOpen(e, "SC");}}>SPECIAL SCOPES</button>
